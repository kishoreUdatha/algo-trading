...
public class PositionManager {
    ...
    public void updatePosition(String symbol, OrderSide side, int quantity, double price) {
        ...
        try {
            ...
            log.info("Position updated for {}: {} shares, value: {}",
                    symbol, currentQty, currentValue + adjustment);
        ...
        try {
            ...
            long quantity = Long.parseLong(
                    redis.opsForValue().get(positionKey) != null ?
                            redis.opsForValue().get(positionKey) : "0");
